...
public:
    ...
    bool VisitStmt(Stmt *s) {
        ...
        if (isa<ForStmt>(s)) {
            ...
            TheRewriter.ReplaceText(s->getSourceRange(),"for (int i=0;"+
                                    TheRewriter.getRewrittenText(Cond->getSourceRange())+"/Par; i++)"+
                                    TheRewriter.getRewrittenText(Operation->getSourceRange())+"}");
        }
